...
<nav>
	<ul>
		...
		{{if $nav.notifications}}
			<li  id="nav-notifications-linkmenu" class="nav-menu-icon"><a href="{{$nav.notifications.0}}" rel="#nav-notifications-menu" title="{{$nav.notifications.1}}"><span class="icon s22 icon-bell-alt tilted-icon"></span></a>
		...
		{{if $userinfo}}
			<li id="nav-contacts-linkmenu" class="nav-menu-icon">
				<a href="#" rel="#nav-contacts-menu">
					<span class="icon icon-user s22"></span>
